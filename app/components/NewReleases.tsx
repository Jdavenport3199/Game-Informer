...
const NewReleases: React.FC<UpcomingProps> = ({
  newReleases,
  selectedGame,
  setSelectedGame,
}) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        let storedGameDataNewReleases = localStorage.getItem(
          "gameDataNewReleases"
        );
        ...
        if (
          ...
          setGameData(JSON.parse(storedGameDataNewReleases));
        }
      } catch (error) {
